...
import { StyleSheet, Text, View, TouchableOpacity, ImageBackground, StatusBar, ScrollView } from 'react-native';
...
function GarageManagerPage({ navigation }) {
  const garageImage = "https://nnhome.com.vn/wp-content/uploads/2023/02/Thiet-ke-nha-xuong-gara-o-to-53.jpg";
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.overlay}>
          <View style={styles.headerContainer}>
            ...
            <Text style={styles.headerSubtitle}>Quản lý garage chuyên nghiệp</Text>
          </View>
        </View>
      </ImageBackground>
      ...
      <ScrollView style={styles.contentContainer}>
        <View style={styles.welcomeSection}>
          <Text style={styles.welcomeText}>Chào mừng đến với Hệ thống Quản lý Garage</Text>
          <Text style={styles.welcomeSubText}>Quản lý garage của bạn một cách hiệu quả</Text>
        </View>
        ...
        <View style={styles.menuGrid}>
          ...
          >
            <Card style={styles.card}>
              <Card.Content style={styles.cardContent}>
                ...
                <Paragraph style={styles.cardDescription}>Quản lý lịch hẹn</Paragraph>
              </Card.Content>
            </Card>
          </TouchableOpacity>
          ...
          >
            <Card style={styles.card}>
              <Card.Content style={styles.cardContent}>
                ...
                <Paragraph style={styles.cardDescription}>Xem báo cáo và thống kê</Paragraph>
              </Card.Content>
            </Card>
          </TouchableOpacity>
          ...
          >
            <Card style={styles.card}>
              <Card.Content style={styles.cardContent}>
                ...
                <Paragraph style={styles.cardDescription}>Quản lý hóa đơn và thanh toán</Paragraph>
              </Card.Content>
            </Card>
          </TouchableOpacity>
          ...
          >
            <Card style={styles.card}>
              <Card.Content style={styles.cardContent}>
                <MaterialIcons name="miscellaneous-services" size={36} color="#6200ea" />
                <Title style={styles.cardTitle}>Dịch vụ</Title>
                <Paragraph style={styles.cardDescription}>Quản lý các dịch vụ</Paragraph>
              </Card.Content>
            </Card>
          </TouchableOpacity>
        </View>
